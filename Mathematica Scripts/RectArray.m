...
labels1 = ['latstart','latend','lonstart','lonend']
description1 = 'Geographical area of interest'
defaults1 = [str(randint(*ran)) for ran in [(-35,-10),(10,35),(-75,-10),(10,75)]]
region1 = GeoRegionArg('aoi',description1,labels1,defaults1,label_loc="top")
interval = PopupSelectArg('interval',['Second','Minute','Hour','Day','Week','Month','Year'],'Length of each time slice','Minute')
totalsize = IntegerArg('totalsize','Width of the resulting image','1000')
args = [ [region1],[totalsize] ]
...
(*Export["1.txt","Data broken into runs: "<>ToString[Dimensions[runs2]]];*)

runbuffers=ParallelMap[update,runs2];

(*Export["2.txt","Runs compiled into buffers: "<>ToString[Dimensions[runbuffers]]];*)
...
(*Export["3.txt","run buffers combined "<>ToString[Dimensions[buffer]]];*)
...
Export["mapoverlay.jpg",Column[{Image[mapoverlay,ImageSize->Reverse[dims]],"Latitude range: "<>latstart<>" to "<>latend,"Longitude range: "<>lonstart<>" to "<>lonend,"Start: "<>DateString[parseDate[startDateTime]],"End: "<>DateString[parseDate[endDateTime]],"Dataset: "<>datasets[[3]],"Data streams: "<>streams},Alignment->{Center,Center,Left}]];

Export["image.jpg",Column[{ArrayPlot[GaussianFilter[dataArray, 5],ImageSize->Reverse[dims]],"Latitude range: "<>latstart<>" to "<>latend,"Longitude range: "<>lonstart<>" to "<>lonend,"Start: "<>DateString[parseDate[startDateTime]],"End: "<>DateString[parseDate[endDateTime]],"Dataset: "<>datasets[[3]],"Data streams: "<>streams},Alignment->{Center,Center,Left}]];
