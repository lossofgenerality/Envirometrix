...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MathematicaSource'
        db.create_table(u'data_mathematicasource', (
        ...
        db.send_create_signal(u'data', ['MathematicaSource'])


    def backwards(self, orm):
        # Deleting model 'MathematicaSource'
        db.delete_table(u'data_mathematicasource')
