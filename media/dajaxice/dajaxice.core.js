...
var Dajaxice = {
    ...
    search_data: function(callback_function, argv, custom_settings){
        return Dajaxice.call('analysis.search_data', 'POST', callback_function, argv, custom_settings);
    },

    get_args: function(callback_function, argv, custom_settings){
        return Dajaxice.call('analysis.get_args', 'POST', callback_function, argv, custom_settings);
    }
